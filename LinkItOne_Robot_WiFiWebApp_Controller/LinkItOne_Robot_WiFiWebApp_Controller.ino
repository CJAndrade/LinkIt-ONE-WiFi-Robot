//@CarmelitoA 13-Nov-2015 basic Obstacle Avoiding Robot (part 3 -WiFi controller Web App)
...
#define WIFI_AP "XXXXXXX" //WiFi  name
      ...
      if (client.available()) {
        ...
        if (readString.length() < 100) {
         ...
         if (c == '\n') {          
           ...
           client.println("<html>");
           client.println("<head>");
           client.println("<title>LinkIt ONE Robo Controller</title>");
           ...
           if (readString.indexOf("?stopAll") >0){
            ...
            //using the Ultrasonic sensor to stop the robot in case you in front of an object just after hitting a button
            ...
            Serial.println(cm);
             //check object detection distance
              if (cm < 10) {
